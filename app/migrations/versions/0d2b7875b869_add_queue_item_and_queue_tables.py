"""add queue_item and queue tables

Revision ID: 0d2b7875b869
Revises: 29870d20b68f
Create Date: 2025-05-19 18:45:57.327478
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('rpa_event_log_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
